...
public:
    ...
    void setupUi(QMainWindow *Schedule)
    {
        ...
        Schedule->resize(933, 987);
        centralwidget = new QWidget(Schedule);
        centralwidget->setObjectName("centralwidget");
        stackedWidget = new QStackedWidget(centralwidget);
        stackedWidget->setObjectName("stackedWidget");
        stackedWidget->setGeometry(QRect(50, 80, 821, 851));
        page = new QWidget();
        ...
        groupBox->setGeometry(QRect(80, 360, 261, 131));
        ...
        s_le = new QLineEdit(groupBox);
        s_le->setObjectName("s_le");

        horizontalLayout->addWidget(s_le);
        ...
        e_le = new QLineEdit(groupBox);
        e_le->setObjectName("e_le");

        horizontalLayout_2->addWidget(e_le);
        ...
        menubar = new QMenuBar(Schedule);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 933, 23));
        Schedule->setMenuBar(menubar);
        statusbar = new QStatusBar(Schedule);
        statusbar->setObjectName("statusbar");
        Schedule->setStatusBar(statusbar);

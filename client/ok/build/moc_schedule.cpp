...
template <> constexpr inline auto Schedule::qt_create_metaobjectdata<qt_meta_tag_ZN8ScheduleE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Schedule",
        "onCalendarDateSelected_start",
        "",
        "date",
        "onCalendarDateSelected_end",
        "onTableItemClicked",
        "row",
        "column"
    };
...
void Schedule::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onCalendarDateSelected_start((*reinterpret_cast< std::add_pointer_t<QDate>>(_a[1]))); break;
        case 1: _t->onCalendarDateSelected_end((*reinterpret_cast< std::add_pointer_t<QDate>>(_a[1]))); break;
        case 2: _t->onTableItemClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
}
